...
<br>
1. Open the terminal
2. Type "<b>cd</b> " then drag the folder of desired directory to the terminal 
...
6. To activate virtual environment: "<b>source ./myvenv/bin/activate</b>"
7. To install the packages: "<b>pip install -r requirements.txt</b>"
8. To automate the pipeline: "<b>make process</b>"
9. To run test scripts: "<b>python3 manage.py test</b>"
